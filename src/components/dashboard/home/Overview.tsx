...
const svgIcon = (
  <svg
    ...
    <g clipPath="url(#clip0_0_169)">
      <path
        d="M6.16931 7.65473C6.41081 6.62616 7.87488 6.62616 8.11637 7.65473L8.81505 10.6306C8.89991 10.992 9.178 11.2767 9.53734 11.3699L12.5568 12.1537C13.5551 12.4128 13.5551 13.8304 12.5568 14.0895L9.53734 14.8733C9.178 14.9666 8.89991 15.2512 8.81505 15.6127L8.11637 18.5885C7.87487 19.6171 6.41081 19.6171 6.16931 18.5885L5.47063 15.6127C5.38577 15.2512 5.10768 14.9666 4.74834 14.8733L1.72892 14.0895C0.730577 13.8304 0.73058 12.4128 1.72892 12.1537L4.74834 11.3699C5.10768 11.2767 5.38577 10.992 5.47063 10.6306L6.16931 7.65473Z"
        fill="black"
      />
      <path
        d="M18.1693 1.64643C18.4108 0.617857 19.8749 0.617856 20.1164 1.64643L20.1362 1.73103C20.2211 2.09245 20.4992 2.37711 20.8585 2.47039L21.1282 2.54039C22.1265 2.79953 22.1265 4.21709 21.1282 4.47623L20.8585 4.54623C20.4992 4.63951 20.2211 4.92417 20.1362 5.28559L20.1164 5.37019C19.8749 6.39876 18.4108 6.39876 18.1693 5.37019L18.1495 5.28559C18.0646 4.92417 17.7865 4.63951 17.4272 4.54623L17.1575 4.47623C16.1592 4.21709 16.1592 2.79953 17.1575 2.54039L17.4272 2.47039C17.7865 2.37711 18.0646 2.09245 18.1495 1.73103L18.1693 1.64643Z"
        fill="black"
      />
      <path
  ...
  return (
    <div className="mt-10">
      <div className="flex justify-between flex-wrap">
        <h1 className="font-bold text-lg lg:text-start lg:w-auto text-center w-full">
          Overview
        </h1>
      ...
      <Alert
        ...
        message="Total impression is 11% higher than the previous period. Most viewed story group is Beef Empanadas with Chimichurri Sauce"
      />

      <div className="mt-7 grid grid-cols-1 lg:gap-0 gap-5 lg:grid-cols-3">
        <Card>
          <div className="flex flex-col items-center space-y-3">
            <h1 className="text-[#3a3a62] text-lg font-medium">
              Avg. Engagement Rate{" "}
              <InfoCircleOutlined className="text-[0.8rem] ml-1 cursor-pointer relative bottom-[1.5px] " />
            </h1>
            <h1 className="text-[#3a3a62] text-xl font-extrabold">
              {(
                analytics.filter(
        ...
        <Card>
          <div className="flex flex-col items-center space-y-3">
            <h1 className="text-[#3a3a62] text-lg font-medium">
              Avg. CTR{" "}
              <InfoCircleOutlined className="text-[0.8rem] ml-2 cursor-pointer relative bottom-[1.5px]" />
            </h1>
            <h1 className="text-[#3a3a62] text-xl font-extrabold">
              {(
                analytics.filter(
        ...
        <Card>
          <div className="flex flex-col items-center space-y-3">
            ...
            <h1 className="text-[#3a3a62] text-xl font-extrabold">
              {(
                analytics.filter(
                  (obj: { name: string }) => obj.name === "reels_opened"
                ).length /
                analytics.filter(
                  (obj: { name: string }) => obj.name === "reels_init"
                ).length
